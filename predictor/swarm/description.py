...
'/home/ricardo/.local/lib/python2.7/site-packages/nupic-0.1.0-py2.7.egg/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
control = {
  ...
  'dataset' : {   u'info': u'kw_energy_consumption',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Rec Center',
                            u'source': u'file://rec-center-hourly.csv'}],
        u'version': 1},
 ...
 u'predictionSteps': [1]},
  ...
  'metrics':[
    MetricSpec(field=u'kw_energy_consumption', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'kw_energy_consumption', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
