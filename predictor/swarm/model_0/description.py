...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {'_classifierInput': {'maxval': 53.0, 'classifierOnly': True, 'minval': 0.0, 'clipInput': True, 'n': 275, 'fieldname': 'kw_energy_consumption', 'w': 21, 'type': 'ScalarEncoder'}, u'timestamp_timeOfDay': None, u'timestamp_dayOfWeek': None, u'kw_energy_consumption': {'maxval': 53.0, 'name': 'kw_energy_consumption', 'clipInput': True, 'minval': 0.0, 'n': 272, 'fieldname': 'kw_energy_consumption', 'w': 21, 'type': 'ScalarEncoder'}, u'timestamp_weekend': None}}, 'spParams': {'synPermInactiveDec': 0.05015}, 'tpParams': {'minThreshold': 11, 'activationThreshold': 14, 'pamLength': 3}, 'clParams': {'alpha': 0.050050000000000004}},
